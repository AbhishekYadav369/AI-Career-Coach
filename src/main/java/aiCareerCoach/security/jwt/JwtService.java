...
/*
 Note: In a real application, ensure to securely manage
 the secret key and consider using environment variables or a secure vault.
*/
...
// Method to generate a JWT token
    ...
    public String generateToken(String username) {
            ...
            claims.put("username", username); // Adding custom claims
